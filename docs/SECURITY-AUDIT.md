...
- ⬜ **Plaintext sensitive fields**: income + city/postal + mailing/previous/worksite addresses + employer address are plaintext while primary address/DOB/ID are encrypted. **Decision needed**: encrypt to match, or document the tier.
