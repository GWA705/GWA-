...
import { ProductMixView } from './ProductMixView';
...
export default async function ProductMixPage({
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionHero
        eyebrow={t('productMix.eyebrow')}
        title={t('productMix.title')}
        subtitle={t('productMix.subtitle')}
      />
      ...
      {!reportingJournalEnabled() ? (
        ...
        <ProductMixView report={await buildProductMix(officeId, year)} />
      )}
    </div>
  );
}
