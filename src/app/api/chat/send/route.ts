...
export async function POST(req: NextRequest) {
  ...
  // The assistant reply for a dealer's General support message is generated by a
  // separate call the chat widget awaits (POST /api/chat/assistant) — reliable
  // even across a redeploy, unlike a fire-and-forget task.
